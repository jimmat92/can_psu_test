...
try:
    ...
    sys.exit("cannot import elmbpsu_can from lib/ - activate the venv first:\n"
             "    source .venv/bin/activate && elmbpsu-selftest\n"
             "(build it with ./setup.sh if it is not there yet)")
